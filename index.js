...
for(let i = 0; i < words.length; i++) {
  if(words[i].indexOf("the")===1 || words[i].indexOf("a")===1 || words[i].indexOf("an")===1 || words[i].indexOf("but")===1 || words[i].indexOf("of")===1 || words[i].indexOf("and")===1 || words[i].indexOf("and")===1){
